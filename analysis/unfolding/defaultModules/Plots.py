    ...
    def getHistSetups(self,channel):
        ...
        return [
            ...
            },
            {
                ...
                "ytitle":"Events / 0.1#kern[-0.4]{ }units",
                "selection":self.module("Samples").getNjets(2)+"*"+self.module("Samples").getNbjets(1)+"*"+bgSelection,
                "binning":numpy.linspace(-1,1,num=21),
                "legendPos":"L",
                "normalize":False,
                "logy":False,
                "cut":"m#lower[0.3]{#scale[0.7]{T}}(W)#kern[-0.4]{ }>#kern[-0.4]{ }50#kern[-0.2]{ }GeV, BDT#lower[0.3]{#scale[0.7]{#it{t}-ch.}}#kern[-0.4]{ }<#kern[-0.4]{ }0",
                "region":"2j1b",
                "resRange":0.2,
            ...
            },
            {
                ...
                "normalize":False,
                "logy":False,
                "cut":"m#lower[0.3]{#scale[0.7]{T}}(W)#kern[-0.4]{ }>#kern[-0.4]{ }50#kern[-0.2]{ }GeV",
                "region":"2j1b",
                "resRange":0.2,
            ...
            
            {
                ...
                "ytitle":"#LT#kern[-0.5]{ }#lower[0.03]{Events / GeV}#kern[-0.5]{ }#GT",
                ...
                "normalize":True,
                "logy":True,
                "cut":"m#lower[0.3]{#scale[0.7]{T}}(W)#kern[-0.4]{ }>#kern[-0.4]{ }50#kern[-0.2]{ }GeV, BDT#lower[0.3]{#scale[0.7]{#it{t}-ch.}}#kern[-0.4]{ }>#kern[-0.4]{ }0.7",
                "region":"2j1b",
                "resRange":0.2,
                "marks":[]
            },
            ...
            },
            {
                ...
                "xtitle":"cos#kern[0.1]{#theta}#scale[0.7]{#lower[0.28]{pol.}}#kern[-4.2]{ }*  ",
                "ytitle":"#LT#kern[-0.5]{ }#lower[0.03]{Events}#kern[-0.5]{ }#GT",
                "selection":self.module("Samples").getNjets(2)+"*"+self.module("Samples").getNbjets(1)+"*"+srSelection,
            ...
            
            {
                ...
                "var":"SingleTop_1__Top_1__Pt",
                "xtitle":"Top quark p#scale[0.7]{#lower[0.3]{T}} (GeV)",
                "ytitle":"Events / 12#kern[-0.4]{ }GeV",
                "selection":self.module("Samples").getNjets(2)+"*"+self.module("Samples").getNbjets(1)+"*"+crSelection,
                "binning":numpy.linspace(0,300,num=26),
                "legendPos":"R",
                "normalize":False,
                "logy":False,
                "cut":"m#lower[0.3]{#scale[0.7]{T}}(W)#kern[-0.4]{ }>#kern[-0.4]{ }50#kern[-0.2]{ }GeV, BDT#lower[0.3]{#scale[0.7]{#it{t}-ch.}}#kern[-0.4]{ }<#kern[-0.3]{ }0",
                "region":"2j1b",
                "resRange":0.2,
                "marks":[]
            },
            {
                ...
                "ytitle":"Events / 0.1#kern[-0.4]{ }units",
                "selection":self.module("Samples").getNjets(2)+"*"+self.module("Samples").getNbjets(1)+"*"+crSelection,
                "binning":numpy.linspace(0,2.6,num=27),
                "legendPos":"R",
                "normalize":False,
                "logy":False,
                "cut":"m#lower[0.3]{#scale[0.7]{T}}(W)#kern[-0.4]{ }>#kern[-0.4]{ }50#kern[-0.2]{ }GeV, BDT#lower[0.3]{#scale[0.7]{#it{t}-ch.}}#kern[-0.4]{ }<#kern[-0.3]{ }0",
            ...
            },
            {
                ...
                "var":"SingleTop_1__cosTheta_tPLz",
                "xtitle":"cos#kern[0.1]{#theta}#scale[0.7]{#lower[0.28]{pol.}}#kern[-4.2]{ }*  ",
                "ytitle":"Events / 0.08#kern[-0.4]{ }units",
                "selection":self.module("Samples").getNjets(2)+"*"+self.module("Samples").getNbjets(1)+"*"+crSelection,
            ...
            },
            {
                ...
                "var":"SingleTop_1__TightLepton_1__Pt",
                "xtitle":"Lepton p#scale[0.7]{#lower[0.3]{T}} (GeV)",
                "ytitle":"Events / 8#kern[-0.4]{ }GeV",
                "selection":self.module("Samples").getNjets(2)+"*"+self.module("Samples").getNbjets(1)+"*"+crSelection,
                "binning":numpy.linspace(0,200,num=26),
                "legendPos":"R",
                "normalize":False,
                "logy":False,
                "cut":"m#lower[0.3]{#scale[0.7]{T}}(W)#kern[-0.4]{ }>#kern[-0.4]{ }50#kern[-0.2]{ }GeV, BDT#lower[0.3]{#scale[0.7]{#it{t}-ch.}}#kern[-0.4]{ }<#kern[-0.3]{ }0",
            ...
            },
            {
                ...
                "ytitle":"Events / 0.1#kern[-0.4]{ }units",
                "selection":self.module("Samples").getNjets(2)+"*"+self.module("Samples").getNbjets(1)+"*"+crSelection,
                "binning":numpy.linspace(0,2.4,num=25),
                "legendPos":"R",
                "normalize":False,
                "logy":False,
                "cut":"m#lower[0.3]{#scale[0.7]{T}}(W)#kern[-0.4]{ }>#kern[-0.4]{ }50#kern[-0.2]{ }GeV, BDT#lower[0.3]{#scale[0.7]{#it{t}-ch.}}#kern[-0.4]{ }<#kern[-0.3]{ }0",
            ...
            },
            {
                ...
                "ytitle":"Events / 10#kern[-0.4]{ }GeV",
                "selection":self.module("Samples").getNjets(2)+"*"+self.module("Samples").getNbjets(1)+"*"+crSelection,
                "binning":numpy.linspace(0,250,num=26),
                "legendPos":"R",
                "normalize":False,
                "logy":False,
                "cut":"m#lower[0.3]{#scale[0.7]{T}}(W)#kern[-0.4]{ }>#kern[-0.4]{ }50#kern[-0.2]{ }GeV, BDT#lower[0.3]{#scale[0.7]{#it{t}-ch.}}#kern[-0.4]{ }<#kern[-0.3]{ }0",
