...
class SamplesTtbarPtDown(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesTtbarPtDown.baseClass.__init__(self,options)
...
class UtilsTtbarPtDown(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsTtbarPtDown.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
