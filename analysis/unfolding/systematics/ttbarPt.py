...
class SamplesTtbarPt(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesTtbarPt.baseClass.__init__(self,options)
...
class UtilsTtbarPt(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsTtbarPt.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
