...
class SamplesbfracCentral(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesbfracCentral.baseClass.__init__(self,options)
    ...
    def getSample(self,name,channel="mu",sys=None):
        ...
        sampleDict = {
            ...
            {
                "processes":[
                    "ST_t-channel_top_4f_inclusiveDecays_13TeV-powhegV2-madspin-pythia8_TuneCUETP8M1_withBFrag"+sys,
                    "ST_t-channel_antitop_4f_inclusiveDecays_13TeV-powhegV2-madspin-pythia8_TuneCUETP8M1_withBFrag"+sys
                ],
                "weight":mcweightIso+"*(PTR_1__centralFrag)"
            },
            ...
            {
                "processes":[
                    "TT_TuneCUETP8M2T4_13TeV-powheg-pythia8_withBFrag"+sys
                ],
                "weight":mcweightIso+"*(Generated_1__top_pt_rew)*(PTR_1__centralFrag)"
            },
...
class UtilsbfracCentralModule(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsbfracCentralModule.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
