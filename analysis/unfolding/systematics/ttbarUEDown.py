...
class SamplesTtbarUEDown(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesTtbarUEDown.baseClass.__init__(self,options)
...
class UtilsTtbarUEDown(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsTtbarUEDown.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
