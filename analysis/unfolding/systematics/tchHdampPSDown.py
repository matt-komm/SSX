...
class SamplestchHdampPSDown(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplestchHdampPSDown.baseClass.__init__(self,options)
...
class UtilstchHdampPSDown(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilstchHdampPSDown.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
        
    def getUncertaintyName(self):
        return "tchHdampPSDown"
