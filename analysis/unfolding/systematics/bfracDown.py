...
class SamplesbfracDown(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesbfracDown.baseClass.__init__(self,options)
    ...
    def getSample(self,name,channel="mu",sys=None):
        ...
        sampleDict = {
            "tChannel":
            {
                ...
                "weight":mcweightIso+"*(PTR_1__downFrag)"
            },
            ...
            "TTJets":
            {
                ...
                "weight":mcweightIso+"*(Generated_1__top_pt_rew)*(PTR_1__downFrag)"
            },
...
class UtilsbfracDown(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsbfracDown.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
