...
class SamplesTchanScalePSDown(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesTchanScalePSDown.baseClass.__init__(self,options)
...
class UtilsTchanScalePSDown(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsTchanScalePSDown.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
        
    def getUncertaintyName(self):
        return "tchanScalePSDown"
