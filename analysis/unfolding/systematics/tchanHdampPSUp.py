...
class SamplesTchanHdampPSUp(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesTchanHdampPSUp.baseClass.__init__(self,options)
    ...
    def getSample(self,name,channel="mu",sys=None):
        ...
        sampleDict = {
            ...
            {
                "processes":[
                    "ST_t-channel_top_4f_hdampup_inclusiveDecays_13TeV-powhegV2-madspin-pythia8"+sys,
                    "ST_t-channel_antitop_4f_hdampup_inclusiveDecays_13TeV-powhegV2-madspin-pythia8"+sys
                ],
                "weight":mcweightIso
            },
...
class UtilsTchanHdampPSUp(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsTchanHdampPSUp.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
        
    def getUncertaintyName(self):
        return "tchanHdampPSUp"
