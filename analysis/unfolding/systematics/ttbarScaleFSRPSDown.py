...
class SamplesTtbarScaleFSRPSDown(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesTtbarScaleFSRPSDown.baseClass.__init__(self,options)
    ...
    def getSample(self,name,channel="mu",sys=None):
        ...
        sampleDict = {
            ...
            {
                "processes":[
                    "TT_TuneCUETP8M2T4_13TeV-powheg-fsrdown-pythia8_ext"+sys
                ],
...
class UtilsTtbarScaleFSRPSDown(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsTtbarScaleFSRPSDown.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
        
    def getUncertaintyName(self):
        return "ttbarScaleFSRPSDown"
