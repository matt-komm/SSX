...
class SamplesTtbarScaleFSRPSUp(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesTtbarScaleFSRPSUp.baseClass.__init__(self,options)
    ...
    def getSample(self,name,channel="mu",sys=None):
        ...
        sampleDict = {
            ...
            {
                "processes":[
                    "TT_TuneCUETP8M2T4_13TeV-powheg-fsrup-pythia8"+sys
                ],
...
class UtilsTtbarScaleFSRPSUp(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsTtbarScaleFSRPSUp.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
        
    def getUncertaintyName(self):
        return "ttbarScaleFSRPSUp"
