...
class SamplesTtbarUEUp(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesTtbarUEUp.baseClass.__init__(self,options)
    ...
    def getSample(self,name,channel="mu",sys=None):
        ...
        sampleDict = {
            ...
            {
                "processes":[
                    "TT_TuneCUETP8M2T4up_13TeV-powheg-pythia8_ext"+sys
                ],
...
class UtilsTtbarUEUp(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsTtbarUEUp.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
