...
class SamplesTtbarHdampPSUp(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesTtbarHdampPSUp.baseClass.__init__(self,options)
    ...
    def getSample(self,name,channel="mu",sys=None):
        ...
        sampleDict = {
            ...
            {
                "processes":[
                    "TT_hdampUP_TuneCUETP8M2T4_13TeV-powheg-pythia8_ext"+sys
                ],
...
class UtilsTtbarHdampPSUp(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsTtbarHdampPSUp.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
        
    def getUncertaintyName(self):
        return "ttbarHdampPSUp"
