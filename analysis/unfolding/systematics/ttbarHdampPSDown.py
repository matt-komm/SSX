...
class SamplesTtbarHdampPSDown(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesTtbarHdampPSDown.baseClass.__init__(self,options)
    ...
    def getSample(self,name,channel="mu",sys=None):
        ...
        sampleDict = {
            ...
            {
                "processes":[
                    "TT_hdampDOWN_TuneCUETP8M2T4_13TeV-powheg-pythia8_ext"+sys
                ],
...
class UtilsTtbarHdampPSDown(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsTtbarHdampPSDown.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
        
    def getUncertaintyName(self):
        return "ttbarHdampPSDown"
