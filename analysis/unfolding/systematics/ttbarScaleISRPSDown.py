...
class SamplesTtbarScaleISRPSDown(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesTtbarScaleISRPSDown.baseClass.__init__(self,options)
    ...
    def getSample(self,name,channel="mu",sys=None):
        ...
        sampleDict = {
            ...
            {
                "processes":[
                    "TT_TuneCUETP8M2T4_13TeV-powheg-isrdown-pythia8_ext"+sys
                ],
...
class UtilsTtbarScaleISRPSDown(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsTtbarScaleISRPSDown.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
        
    def getUncertaintyName(self):
        return "ttbarScaleISRPSDown"
