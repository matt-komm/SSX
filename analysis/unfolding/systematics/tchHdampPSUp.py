...
class SamplestchHdampPSUp(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplestchHdampPSUp.baseClass.__init__(self,options)
...
class UtilstchHdampPSUp(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilstchHdampPSUp.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
