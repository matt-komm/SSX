...
class SamplesTtbarScaleISRPSUp(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesTtbarScaleISRPSUp.baseClass.__init__(self,options)
    ...
    def getSample(self,name,channel="mu",sys=None):
        ...
        sampleDict = {
            ...
            {
                "processes":[
                    "TT_TuneCUETP8M2T4_13TeV-powheg-isrup-pythia8_ext"+sys
                ],
...
class UtilsTtbarScaleISRPSUp(Module.getClass("Utils")):
    def __init__(self,options=[]):
        UtilsTtbarScaleISRPSUp.baseClass.__init__(self,options)
        self._logger = logging.getLogger(__file__)
        self._logger.setLevel(logging.DEBUG)
        
    def getUncertaintyName(self):
        return "ttbarScaleISRPSUp"
