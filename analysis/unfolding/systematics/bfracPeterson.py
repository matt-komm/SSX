...
class SamplesbfracPeterson(Module.getClass("Samples")):
    def __init__(self,options=[]):
        SamplesbfracPeterson.baseClass.__init__(self,options)
    ...
    def getSample(self,name,channel="mu",sys=None):
        ...
        sampleDict = {
            "tChannel":
            {
                ...
                "weight":mcweightIso+"*(PTR_1__PetersonFrag)"
            },
            ...
            "TTJets":
            {
                ...
                "weight":mcweightIso+"*(Generated_1__top_pt_rew)*(PTR_1__PetersonFrag)"
            },
