...
class SamplesTopMassDown(Module.getClass("Samples")):
    ...
    def getSample(self,name,channel="mu",sys=None):
        ...
        sampleDict = {
            ...
            {
                "processes":[
                    "ST_tW_antitop_5f_mtop1695_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1"+sys,
                    "ST_tW_top_5f_mtop1695_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1"+sys
                ],
                "weight":mcweightIso
            },
