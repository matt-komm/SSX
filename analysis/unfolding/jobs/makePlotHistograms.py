...
config.batchScriptsFilename = 'makePlotHistograms.sh'
...
for channel in ["mu","ele"]:
        ...
        config.inputParams.append([
            "-m tasks/makePlotHistograms -c channel:"+channel+" -c bin:-1"
        ])
